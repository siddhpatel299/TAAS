...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'expense_categories_userId_idx') THEN
        CREATE INDEX "expense_categories_userId_idx" ON "public"."expense_categories"("userId");
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'expenses_userId_idx') THEN
        CREATE INDEX "expenses_userId_idx" ON "public"."expenses"("userId");
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'expenses_categoryId_idx') THEN
        CREATE INDEX "expenses_categoryId_idx" ON "public"."expenses"("categoryId");
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'expenses_date_idx') THEN
        CREATE INDEX "expenses_date_idx" ON "public"."expenses"("date");
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'expense_receipts_userId_idx') THEN
        CREATE INDEX "expense_receipts_userId_idx" ON "public"."expense_receipts"("userId");
    END IF;
END $$;
...
BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'expenses_receiptId_fkey') THEN
