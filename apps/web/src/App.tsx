      ...
      <AuthCheck>
        <DirectUploadProvider>
          <Routes>
            ...
            <Route path="/plugins/job-tracker/email-studio" element={<ProtectedRoute><EmailStudioPage /></ProtectedRoute>} />
    ...
    <AuthCheck>
      <DirectUploadProvider>
        <Routes>
          ...
          />
          <Route
            path="/plugins/job-tracker/email-studio"
            element={
              <ProtectedRoute>
                <EmailStudioPage />
              </ProtectedRoute>
