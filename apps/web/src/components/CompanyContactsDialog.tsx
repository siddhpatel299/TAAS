...
import { jobTrackerApi, ContactForEmail } from '@/lib/plugins-api';
...
export function CompanyContactsDialog({
  ...
  const searchContacts = async () => {
    if (!apiKeysStatus.hasSerpApiKey) {
      setError('SERP API key is required. Please configure it in Job Tracker settings.');
      return;
    }
    ...
    try {
      ...
      const response = await jobTrackerApi.findCompanyContacts(jobId, {
        mode: searchMode,
        targetRoles,
          ...
          >
            ...
            <div className="px-6 py-5 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-sky-50 to-indigo-50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Find Contacts</h2>
            ...
            <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button
                  ...
                  disabled={isLoading || !apiKeysStatus.hasSerpApiKey}
                  className={cn(
                    'flex items-center gap-2 px-5 py-2.5 rounded-xl font-medium transition-all',
                    isLoading || !apiKeysStatus.hasSerpApiKey
            ...
            <div className="flex-1 overflow-y-auto p-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-700 mt-1">
                        To find contacts, you need to configure your SERP API key (required) and Hunter API key (optional, for email discovery) in the Job Tracker settings.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {contacts.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Find Company Contacts</h3>
                  <p className="text-gray-500 max-w-md mx-auto">
                    Search for HR professionals, recruiters, or specific roles at {company}. 
              ...
              {isLoading && (
                <div className="text-center py-12">
                  <Loader2 className="w-10 h-10 mx-auto mb-4 text-sky-500 animate-spin" />
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Searching for contacts...</h3>
