                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex items-center justify-between h-16">
                                ...
                                return (
                                    <Link
                                        ...
                                        className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all ${isActive
                                                ? 'bg-[var(--forest-gradient-primary)] text-white shadow-md'
                                                : 'text-[var(--forest-wood)] hover:bg-[rgba(74,124,89,0.1)] hover:text-[var(--forest-moss)]'
                                            }`}
                                    >
                        ...
                        <div className="flex items-center gap-2">
                            <button className="p-2 rounded-lg text-[var(--forest-wood)] hover:bg-[rgba(74,124,89,0.1)] transition-colors">
